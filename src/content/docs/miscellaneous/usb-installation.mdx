...
<Tabs>
    <TabItem label = "Tinfoil via MTP">
        ...
        {/* <CardGrid> */}
            ...
            <LinkCard title="Tinfoil"></LinkCard>
        {/* </CardGrid> */}
        ### Steps
        ---
...
9. Place your desired title(s) in this folder.
   - The following file formats are supported:
     ...
     - XCZ.
     - NSZ.
10. Your installation should start now, once it is done you should see the installed title on your homescreen.
    - You can disconnect your Switch and exit out of the application.
...
5. Once connected, access the Switch by the new drive named `Switch`.
6. Once inside, access `5. MicroSD Install` to install titles.
7. Place your desired title(s) in this folder.
   - The following file formats are supported:
     - XCI.
     - NSP.
     - XCZ.
     - NSZ.
8. Your installation should start now, once it is done you should see the installed title on your homescreen.
   - You can disconnect your Switch and exit out of the homebrew menu.
...
15. Your installation should start now, once it is done you should see the installed title(s) on your homescreen.
    - You can disconnect your Switch and exit out of the application.
...
14. Your installation should start now, once it is done you should see the installed title(s) on your homescreen.
    - You can disconnect your Switch and exit out of the homebrew menu.
