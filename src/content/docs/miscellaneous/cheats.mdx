    ...
    <TabItem label = "Cheats">
        <Steps>
            ...
            2.  ###### AIO Updater
                ...
                Scroll down to ```Download cheats```.

                You can either select graphics enhancing cheats or individual cheat codes, select the game of your choice and install the cheats of your choice.

                :::note[Network]
                Needs internet to download cheats.
                :::
    ...
    <TabItem label = "Mods">
        <Steps>
            1.  ###### Gamebanana
                ...
                Go to the Gamebanana website. Find a mod you like / want to use and download it.

                Read the instructions for the specific mod you want to install and follow it.
        </Steps>
    </TabItem>
</Tabs>
