...
Now, you will have to choose between either a partition-based emuMMC or file-based emuMMC, you can read about the differences in [Partition-based or file-based](/miscellaneous/partition/) if you still haven't done so.
...
- [Install homebrew apps](/miscellaneous/homebrew/).
- [Install titles via USB](/miscellaneous/usb/).
- [Install themes](/miscellaneous/themes/).
- [Manage cheats](/miscellaneous/cheats/).
- [Manage sysmodules](/miscellaneous/sysmodules/).
- [Setup Tesla overlay](/miscellaneous/tesla/).
- [Emulating Amiibo](/miscellaneous/amiibo/).
