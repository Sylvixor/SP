...
Enabling ```nogc``` **will** prevent you from playing gamecards until you update your Switch to a newer firmware.
    - Read [Update / Downgrade](/important/update/).
...
To fix this, connect your Switch to a charger and let it charge, afterwards you can launch a payload again.
    - Read [Launch payload](/important/payload/).
...
<Tabs>
    <TabItem label = "Old CFW version">
        ...
        To update, install the latest versions of Atmosphere, Hekate and Sigpatches and drop all of the contents of each folder to the root of your microSD card and when it asks to overwrite, click yes for all.
            - You can access your microSD card by taking it out and using a ( micro ) SD card reader or read [browse microSD via USB](/miscellaneous/browse/).
    ...
    <TabItem label = "Broken theme installed">
        ...
        To fix this, access your microSD card ( [browse microSD via USB](/miscellaneous/browse/) ), go into ```/atmosphere/contents/``` and delete the folder named ```/0100000000001000/```.
    ...
    <TabItem label = "Broken sysmodules installed">
        ...
        To fix this, access your microSD card ( [browse microSD via USB](/miscellaneous/browse/) ), inside of ```/atmosphere/```, delete the folder named ```/contents/``` entirely.
...
### Blue screen after updating Atmosphere
