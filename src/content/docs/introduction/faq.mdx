...
A free and open source ( FOSS ) CFW created and maintained by <u>[SciresM](https://github.com/SciresM)</u> and other <u>[contributors](https://github.com/Atmosphere-NX/Atmosphere/graphs/contributors)</u>.
