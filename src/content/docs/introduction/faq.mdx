...
Horizon is the name of the Switch OS.
...
A free and open source [ FOS ] CFW created and maintained by [SciresM](https://github.com/SciresM) and other [contributers](https://github.com/Atmosphere-NX/Atmosphere/graphs/contributors).
...
**Hekate** can be used to boot into OFW, CFW, Android, Linux and everything else inbetween.
